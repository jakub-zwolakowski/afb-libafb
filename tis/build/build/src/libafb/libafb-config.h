...
#define LIBAFB_VERSION_MAJOR   4
#define LIBAFB_VERSION_MINOR   0
#define LIBAFB_VERSION_PATCH   0

#define WITH_SIG_MONITOR_DUMPSTACK 1
// #define WITH_SIG_MONITOR_SIGNALS 1 // DISABLED BY Qba
#define WITH_SIG_MONITOR_SIGNALS 0
#define WITH_SIG_MONITOR_FOR_CALL 1
// #define WITH_SIG_MONITOR_TIMERS 1 // DISABLED BY Qba
#define WITH_SIG_MONITOR_TIMERS 0
#define WITH_AFB_HOOK 1
#define WITH_AFB_TRACE 1
#define WITH_DBUS_TRANSPARENCY 0
#define WITH_SUPERVISION 1
#define WITH_DYNAMIC_BINDING 1
#define WITH_REPLY_JOB 1
#define WITH_SYSTEMD 0
#define WITH_LIBMICROHTTPD 0
#define WITH_ENVIRONMENT 1
#define WITH_AFB_DEBUG 1
#define WITH_CALL_PERSONALITY 1
#define WITH_AFB_CALL_SYNC 1
// #define WITH_FNMATCH 1 // DISABLED BY Qba
...
#define WITH_FDEV_SELECT 0
// #define WITH_CLOCK_GETTIME 1 // DISABLED BY Qba
#define WITH_CLOCK_GETTIME 0
// #define WITH_RANDOM_R 1 // DISABLED BY Qba
#define WITH_RANDOM_R 0
#define WITH_OPENAT 1
#define WITH_DIRENT 1
#define WITH_SYS_UIO 1
#define WITH_LOCALE_FOLDER 1
#define WITH_LOCALE_SEARCH_NODE 1
#define WITH_WSCLIENT_URI_COPY 0
#define WITH_REALPATH 1
#define WITH_CRED 1
#define WITH_UNIX_SOCKET 1
#define WITH_THREAD_LOCAL 1
#define WITH_API_SESSIONS 0
#define WITH_API_CREATOR 1
#define WITH_REQ_PROCESS_ASYNC 1
#define WITH_CASE_FOLDING 0
#define WITH_EXTENSION 1
#define WITH_GNUTLS 0

// DISABLED EVERYTHING -- Qba
...
// #define WITH_THREAD_LOCAL 0
// #define WITH_API_SESSIONS 0
// #define WITH_API_CREATOR 0
// #define WITH_REQ_PROCESS_ASYNC 0
// #define WITH_CASE_FOLDING 0
